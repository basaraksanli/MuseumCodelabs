...
public class Constant {
     ...
     */
    public static final double AWARENESS_BARRIER_RADIUS = 5000.0;
    public static final long AWARENESS_BARRIER_DURATION = 1000L;

    /**
     * Permission Strings
     */
    public static final String[] GUIDE_PERMISSIONS = {
     ...
     */
    public static final int DEFAULT_SEARCH_RANGE = 50;

    /**
     * Predefined Exhibit Info
     */
    public static final List<Exhibit> exhibitInfo = Arrays.asList(
     ...
     */
    public static int EXHIBIT_DETECT_RANGE = 2;
}
